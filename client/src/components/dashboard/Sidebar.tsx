  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className={cn(
          "bg-black/40 backdrop-blur-xl border-r border-white/10 h-screen fixed top-0 z-50 flex flex-col shadow-2xl transition-all duration-300",
          isCollapsed ? "md:w-16" : "w-[260px]",
          "left-0"
        )}
      >
